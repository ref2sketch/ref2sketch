...
def tps_transform(img, dshape=None):
    ...
    while True:
        ...
        point1 = round(random.uniform(0.5, 0.6), 2)
        point2 = round(random.uniform(0.5, 0.6), 2)
        range_1 = round(random.uniform(-0.1, 0.1), 2)
        range_2 = round(random.uniform(-0.1, 0.1), 2)
